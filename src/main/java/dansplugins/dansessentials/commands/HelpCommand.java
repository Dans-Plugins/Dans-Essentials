...
public class HelpCommand extends AbstractPluginCommand {
    ...
    public boolean execute(CommandSender commandSender) {
        ...
        commandSender.sendMessage(ChatColor.AQUA + "/de mute - Mute a player until the next restart.");
        commandSender.sendMessage(ChatColor.AQUA + "/de unmute - Unmute a player.");
